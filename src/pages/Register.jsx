  ...
  return (
    ...
    <div className="max-w-md mx-auto mt-8">
      <form className="mt-[60px] space-y-4">
         <div className='flex flex-col justify-center items-center'> <h3 className='font-bold text-[40px]'>Register</h3></div>
        <div>
      ...
      <p className=' text-[18px] mt-7 '>Already have an account ? <span className=' font-bold'>Login</span></p>
          </div>
      </form>
    </div>
    </div>
